...
public class MovieInventoryDAO {
     ...
     */
    public boolean addMovieToInventory(int inventoryId, int movieId, boolean isAvailable) {
        String sqlStatement = "INSERT INTO movie_inventory (inventory_id, movie_id, is_available) VALUES (?, ?, ?)";
